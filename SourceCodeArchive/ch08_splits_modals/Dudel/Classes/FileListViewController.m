...
- (void)reloadData {
  self.currentDocumentFilename = [FileList sharedInstance].currentFile;
  self.documents = [FileList sharedInstance].allFiles;
...
- (void)viewDidLoad {
    [super viewDidLoad];
  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(fileListChanged:) name:FileListChanged object:[FileList sharedInstance]];
}
