...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {   
  ...
  if (openedUrl) {
    //NSLog(@"launching with file", [openedUrl path]);
    //[[[[UIAlertView alloc] initWithTitle:@"opening with file" message:[openedUrl path] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] autorelease] show];
