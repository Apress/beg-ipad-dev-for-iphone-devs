...
- (void)activate {
  ...
  self.workingPath.lineWidth = delegate.strokeWidth;
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
  ...
  if (workingPath.empty) {
    ...
    workingPath.lineWidth = delegate.strokeWidth;
...
- (void)drawTemporary {
  ...
  if (isDragging) {
    ...
    if (settingFirstPoint) {
      ...
      currentWorkingSegment.lineWidth = delegate.strokeWidth;
  ...
  if (!CGPointEqualToPoint(nextSegmentCp2, nextSegmentPoint2) && !settingFirstPoint) {
    ...
    currentWorkingSegment = [UIBezierPath bezierPath];
    currentWorkingSegment.lineWidth = delegate.strokeWidth;
